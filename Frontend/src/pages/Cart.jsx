      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button onClick={()=> getcartcount() === 0 ?  toast.warn('Add Items to Cart'): navigate('/place-order')&&window.scrollTo(0, 0)} className='cursor-pointer rounded-lg  bg-black text-white text-sm my-8 px-8 py-3 active:bg-gray-800'>Proceed to Checkout</button>
          </div>
        </div>
      </div>
