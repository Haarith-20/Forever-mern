...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 bg-white flex items-center z-50 justify-between py-5  font-medium '>

      <Link to='/'>
        <img src={assets.logo} className="w-36 ml-5" alt="" />
      </Link>
      ...
      <div className='flex items-center gap-6 mr-[4vw]'>
      ...
      <div className={`absolute top-0 right-0 overflow-hidden bg-white transition-all duration-300 ease-out ${visible ? "w-full" : "w-0"} `}>
